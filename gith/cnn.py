...
# from kaggle.dataset import Y_train
...
#from kaggle.dataset import X_train
#from kaggle.model_CNN import Y_train, model
...
train_history = model.fit(X_train, Y_train, batch_size=32,
                          epochs=3, verbose=1, callbacks=callback_list, validation_split=0.2)


from keras.models import load_model

#from kaggle.dataset import X_test
